...
?>
      ...
      <div class="container-fluid">
		...
		<form method="POST" action="processa.php" class="mx-4" enctype="multipart/form-data">
		<div class="my-2 my-5"><h2>Cadastro de Funcionário</h2></div>
		...
		<div class="my-2 my-5"><h4>Informações Gerais</h4></div>			
		  <div class="form-row">
			...
			<div class="form-group col-md-4">
			  ...
			  <input type="number" class="form-control" name="inputSalario" id="inputSalario" placeholder="Salario" required>
			</div>			
		  </div>
		  <div class="form-row">
			<div class="form-group col-md-4">
			  <label for="inputCarteira">CTPS</label>				
			  <input type="text" class="form-control" name="inputCarteira" id="inputCarteira" placeholder="Nº da Carteira de Trabalho">
			</div>
			<div class="form-group col-md-4">
		...
		<div class="my-2 my-5"><h4>Informações Bancárias</h4></div>		  
		  <div class="form-row">
			...
			<div class="form-group col-md-3">
			  ...
			  <input type="text" class="form-control" name="inputAgencia" id="inputAgencia" placeholder="Agencia" required>
			</div>
			<div class="form-group col-md-3">
			  <label for="inputConta">Conta</label>				
			  <input type="text" class="form-control" name="inputConta" id="inputConta" placeholder="Conta" required>
			</div>
		  </div>
		...
		<div class="form-row">	
			...
			<div class="form-group col-md-4">
			  <label for="inputReconfirmacao">Reconfirmação de senha</label>				
			  <input type="password" class="form-control" name="inputReconfirmacao" id="inputReconfirmacao" placeholder="Reconfirmação de senha" required>
			</div>
		</div>
